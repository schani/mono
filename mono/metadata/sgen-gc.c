...
init_stats (void)
{
	...
	sgen_client_counter_register_time ("Minor scan roots", &time_minor_scan_roots, FALSE);
	...
	sgen_client_counter_register_time ("Major scan roots", &time_major_scan_roots, FALSE);
	sgen_client_counter_register_time ("Major scan mod union", &time_major_scan_mod_union, FALSE);
