...
void sgen_null_links_with_predicate (int generation, SgenObjectPredicateFunc predicate, void *data);
...
void sgen_null_links_with_null_vtable (int generation);
...
void sgen_remove_finalizers_with_predicate (SgenObjectPredicateFunc predicate, void *user_data, int generation);
...
void sgen_parallel_pin_or_update (void **ptr, void *obj, GCVTable *vt, SgenGrayQueue *queue);
